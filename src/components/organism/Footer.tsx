...
const Footer = (props: any) => {
  ...
  return (
    <div className="bg-black py-[72px] text-white px-24">
      <div className="flex gap-24">
        ...
        <div className="max-w[400px]">
          ...
          <p>
            Era Prima Warehouse and Industrial Complex Jl. Daan Mogot KM 21 No.
            1 Block Q1 Kel, RT.001/RW.001, Poris Plawad, Cipondoh, Tangerang
            City, Banten 15141
          </p>
