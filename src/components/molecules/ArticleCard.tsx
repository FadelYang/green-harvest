      ...
      <div className="flex flex-col xl:w-[496px] w-[324px] gap-4 shadow-xl">
        <div className="">
          <img
            src={thumbnailImage}
            alt=""
            className="xl:min-w-[496px] xl:min-h-[298px] w-[324px] h-[321px] object-cover"
          />
        </div>
        <div className="flex flex-col gap-2 px-6 pb-6">
          <div className="flex justify-between text-gray-500 ">
            <p className="font-semibold  xl:text-base text-sm xl:leading-[26px] leading-6 tracking-[0.56px]">
              {insightCategory}
            </p>
            <p className="font-normal xl:text-base text-sm leading-6 xl:leading-[34px] tracking-[0.56px]">
              {createdAt}
            </p>
          </div>
